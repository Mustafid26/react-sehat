const tipsKehamilan = [
  {
    minggu: 0,
    tips: [
      'Mulai konsumsi asam folat (jika belum)',
      'Pertimbangkan untuk mengubah gaya hidup sehat sebelum program hamil',
      'Diskusikan rencana kehamilan dengan pasangan dan dokter'
    ]
  },
  {
    minggu: 1,
  ...
  {
    minggu: 8,
    tips: ['Pertimbangkan multivitamin prenatal', 'Lakukan senam hamil ringan']
  },
  {
    minggu: 9,
    tips: [
  ...
  {
    minggu: 18,
    tips: ['Lakukan skrining kelainan bawaan', 'Tetap jaga pola makan seimbang']
  },
  {
    minggu: 19,
  ...
  {
    minggu: 27,
    tips: ['Persiapkan daftar rumah sakit bersalin', 'Rutin ukur tekanan darah']
  },
  {
    minggu: 28,
    tips: [
